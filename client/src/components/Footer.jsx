...
CivicPlus is the platform where your voice drives local change. Easily report issues like broken roads and pollution, vote with your neighbors to prioritize the most urgent problems, and ensure local governments take action based on the real needs of the community.     </p>
        ...
        <div className="mb-6 text-center sm:text-left">
          ...
          <ul>
            ...
            <li className="mb-2 text-sm sm:text-lg">
              <button onClick="" className="hover:underline">AboutUs</button>
            </li>
        ...
        <div className="mb-6 text-center sm:text-left">
          ...
          <p className="text-sm sm:text-lg mb-2"><strong><FontAwesomeIcon icon={faPhone} /></strong> +91 6284938665</p>
          <p className="text-sm sm:text-lg mb-2"><strong><FontAwesomeIcon icon={faEnvelope} /></strong> rahulheer344@gmail.com</p>
        </div>
