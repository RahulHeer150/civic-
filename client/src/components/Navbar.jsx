...
const Navbar = () => {
  ...
  return (
    <>
    <nav className={`fixed top-0 w-full shadow-lg shadow-black/20  rounded-lg z-50 transition duration-300 px-[7vw] md:px-[12vw] lg:px-[10vw] ${isScrolled ? "shadow-lg shadow-black":"bg-[#f1faff]"}`}>
